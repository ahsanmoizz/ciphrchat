...
android {
    ...
    defaultConfig {
        ...
        val turnCredentialUrl = project.providers.gradleProperty("ciphrchatTurnCredentialUrl")
            .orElse(project.providers.environmentVariable("CIPHRCHAT_TURN_CREDENTIAL_URL"))
            .orElse("")
            .get()
            .replace("\\", "\\\\")
            .replace("\"", "\\\"")
